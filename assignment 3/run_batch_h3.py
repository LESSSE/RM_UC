...
parser.add_argument('-n', '--nsamples', type=int, default=500, help='number of samples for each pair of parameters')
...
for p in probs:
    for i in range(n_samples):
        ...
        for c in ["Code2"]:
            ...
            print(f'{c.upper()}:', open(file_).readlines()[-1][:-1]) # print last line from code1 results
...
for i in [2]:
    ...
    export_csv_path = "measurements_h3.csv"
